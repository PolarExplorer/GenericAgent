...
APP_NAME = 'wechatapp'
TARGET = os.path.join(BASE_DIR, 'frontends', 'wechatapp.py')
LOG_FILE = os.path.join(TEMP_DIR, 'wxapp_daemon.log')
STDOUT_LOG = os.path.join(TEMP_DIR, 'wxapp_stdout.log')
