...
|---|---|---|---|---|---|---|---|---|---|
| 005 | 2026-05-06 | 将失败/负样本先纳入 failed log 门控，可减少单次失败被泛化为正向规则 | write_rule | typed_memory_sop.md 增加失败样本禁升规则；failed_experiment_log.md 增加触发、升层、复用与转约束规则 | 待验证 | 待填写 | ⏳ | — | 原则4：失败/负样本接入写入治理 |
